...
export default function transformer(file, api, options) {
  ...
  file.source = transformExpansionPanelComponent(file);
  ...
  file.source = transformGridListComponent(file);
  ...
  file.source = transformRootRef(file);
  ...
  file.source = transformThemeBreakpointsWidth(file);
  file.source = transformThemeOptions(file);
  file.source = transformThemePaletteMode(file);
  file.source = transformThemeProvider(file, api, options);
  file.source = transformThemeSpacing(file);
  file.source = transformThemeTypographyRound(file);
  ...
  file.source = transformMuiReplace(file);
